...
<div class="wrapper">
 ...
 <div class="card">
              <div class="card-header">
                <h3 class="card-title">Register Shifts By One</h3>
              ...
              <div class="card-body p-2">
                ...
                <div class="form-group">  
                 ...
                 <input type="text" class="form-control shift_name" placeholder="shift name"/>
</div>
...
$(document).on("click",'.edit',function(){
  ...
  getShiftData($(this).attr("shiftID"),(response)=>{
    ...
    $(".teachersData").val(response.teacher_id);
    $(".shift_id_hidden").val(response.shift_id);
    $(".save").html("Edit");
